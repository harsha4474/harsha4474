...
- Cut churn by **25%** through cohort analysis and targeted iteration
...
- Launched features driving **30% adoption growth** and **25% retention improvement**
...
**Technical:** Node.js · Express · OpenAI API · Google Sheets API · SendGrid · REST APIs · Jira · Confluence · TestFlight · Firebase
...
*Open to PM · AI Product · Health Tech · Growth roles · Hybrid or Remote · US-based (Atlanta, GA) · F-1 OPT (STEM eligible)*
